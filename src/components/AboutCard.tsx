  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-8 px-4 sm:px-6">
      ...
      <div className="text-center space-y-4 mb-12">
        <span className="text-[10px] font-black tracking-widest text-indigo-650 uppercase font-mono bg-indigo-50 border border-indigo-100 rounded-full px-3 py-1 inline-block">
          Our Blueprint
        </span>
      ...
      <div className="bg-indigo-50/40 border border-indigo-100 p-6 rounded-3xl text-center max-w-3xl mx-auto space-y-4">
        ...
        <div className="flex flex-wrap justify-center gap-3 text-xs font-bold">
          <a href="/salary-calculator.html" className="text-indigo-600 hover:text-indigo-805 bg-white border border-indigo-100 px-4 py-2 rounded-xl transition-all shadow-3xs">
            Salary Calculator
          </a>
          <a href="/sip-calculator.html" className="text-indigo-600 hover:text-indigo-805 bg-white border border-indigo-100 px-4 py-2 rounded-xl transition-all shadow-3xs">
            SIP Calculator
          </a>
          <a href="/nps-calculator.html" className="text-indigo-600 hover:text-indigo-805 bg-white border border-indigo-100 px-4 py-2 rounded-xl transition-all shadow-3xs">
            NPS Pension Calcs
          </a>
        </div>
      </div>
